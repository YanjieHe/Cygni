...
class LexicalException
{
  public:
    ...
    LexicalException(std::shared_ptr<SourceCodeFile> sourceCodeFile, int line, int column,
                     const std::u32string &message)
        : sourceCodeFile{sourceCodeFile}, line{line}, column{column}, message{message}
    {
    }
    ...
    std::u32string FormattedErrorMessage() const
    {
        ...
        return Format(U"File: {} Syntax Error: ({}, {}) {} ", sourceCodeFile->FileName(), actualLine, actualColumn,
                      message);
    }
};
