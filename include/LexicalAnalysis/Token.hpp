...
class Token
{
  public:
    ...
    Token(std::shared_ptr<SourceCodeFile> sourceCodeFile, int line, int column, TokenTag tag,
          const std::u32string &text)
        : sourceCodeFile{sourceCodeFile}, line{line}, column{column}, tag{tag}, text{text}
    {
    }
