...
class Lexer
{
  ...
  public:
    Lexer(std::shared_ptr<SourceCodeFile> sourceCodeFile, const std::u32string &code);
  ...
  private:
    ...
    inline void Match(char32_t c)
    {
        ...
        {
            throw LexicalException(sourceCodeFile, line, column, Format(U"unexpected character '{}'", Peek()));
        }
    }
