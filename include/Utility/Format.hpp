...
std::u32string FormatInternal(std::u32string fmt, std::basic_ostringstream<char32_t> &stream, int i, const T &head,
                              const Args &...rest)
{
...
inline std::u32string FormatInternal(std::u32string fmt, std::basic_ostringstream<char32_t> &stream, int i)
{
    int n = static_cast<int>(fmt.size());
    while (i < n)
    {
