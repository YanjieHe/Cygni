...
class Exception : public std::exception
{
  ...
  public:
    Exception(std::string source, int line, std::string message, const std::exception *innerException)
        : source{source}, line{line}, message{message}, innerException{innerException}
    {
    }
