...
std::unordered_map<std::u32string, TokenTag> Token::keywords = {{U"if", TokenTag::If},
...
std::unordered_map<std::u32string, TokenTag> Token::operators = {{U"+", TokenTag::Add},
                                                                 {U"-", TokenTag::Subtract},
                                                                 {U"*", TokenTag::Multiply},
                                                                 {U"/", TokenTag::Divide},
                                                                 {U"%", TokenTag::Modulo},
