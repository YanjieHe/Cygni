...
TEST_CASE("Nested Operations with Mixed Types", "[Arithmetic]")
{
    ...
    Lexer lexer(sourceCodeFile, U"((5 + 3.5) * (8.0 / 2) - 3 % 2) + 4.5E2 - 0.005E-3");
...
TEST_CASE("Multi-line Expressions with Comments", "[Arithmetic]")
{
    ...
    Lexer lexer(sourceCodeFile, U"var result = x + y  // Adding x and y\n                 - (z * w) // "
...
TEST_CASE("var unicodeEscape = '\\u006A'; // Represents the letter 'j'", "[CharacterLiterals]")
{
    ...
    Lexer lexer(sourceCodeFile, U"var unicodeEscape = '\\u006A'; // Represents the letter 'j'");
...
TEST_CASE("var hexEscape = '\\x4A'; // Represents the letter 'J'", "[CharacterLiterals]")
{
    ...
    Lexer lexer(sourceCodeFile, U"var hexEscape = '\\x4A'; // Represents the letter 'J'");
...
TEST_CASE("Long String with Multiple Escape Sequences", "[String]")
{
    ...
    Lexer lexer(sourceCodeFile, U"\"This is a \\\"complicated\\\" string with newlines\\n\\t and "
