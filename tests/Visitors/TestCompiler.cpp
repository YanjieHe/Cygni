...
TEST_CASE("test conditional expression compilation", "[Compiler][Conditional]")
{
    flint_bytecode::ByteCodeProgram program = CompileProgram(
        U"module A { func Max(a: Int, b: Int): Int { if (a > b) { a; } else { b; } } "
...
{
    flint_bytecode::ByteCodeProgram program = CompileProgram(
        U"module A { func Clamp(x: Int, low: Int, high: Int): Int { "
...
{
    flint_bytecode::ByteCodeProgram program = CompileProgram(
        U"module A { func Sum(n: Int): Int { var result = 0; var i = 1; "
...
{
    flint_bytecode::ByteCodeProgram program = CompileProgram(
        U"module A { func Multiply(a: Int, b: Int): Int { var result = 0; var i = 0; "
...
{
    flint_bytecode::ByteCodeProgram program = CompileProgram(
        U"module A { func Compute(x: Int): Int { var a = x + 1; var b = a * 2; b; } "
...
{
    flint_bytecode::ByteCodeProgram program = CompileProgram(
        U"module A { func Increment(x: Int): Int { var a = x; a = a + 1; a = a + 1; a; } "
