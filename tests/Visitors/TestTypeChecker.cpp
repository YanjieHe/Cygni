...
TEST_CASE("test variable declaration", "[Variable]")
{
    ...
    std::vector<TokenTag> expectedTags = {
        TokenTag::LeftBrace, TokenTag::Var,        TokenTag::Identifier, TokenTag::Assign,     TokenTag::Character,
        TokenTag::Semicolon, TokenTag::Identifier, TokenTag::Semicolon,  TokenTag::RightBrace, TokenTag::Eof};
...
TEST_CASE("test shadowing outer variable", "[Variable]")
{
    ...
    Lexer lexer(sourceCodeFile, U"{ var x = 10; { var x = \"variable x\"; x; }; }");

    std::vector<Token> tokens = lexer.ReadAll();

    std::vector<TokenTag> expectedTags = {
        TokenTag::LeftBrace, TokenTag::Var,        TokenTag::Identifier, TokenTag::Assign,     TokenTag::Integer,
        TokenTag::Semicolon, TokenTag::LeftBrace,  TokenTag::Var,        TokenTag::Identifier, TokenTag::Assign,
        TokenTag::String,    TokenTag::Semicolon,  TokenTag::Identifier, TokenTag::Semicolon,  TokenTag::RightBrace,
...
TEST_CASE("test conditional", "[Conditional]")
{
    ...
    std::vector<TokenTag> expectedTags = {
        TokenTag::If,        TokenTag::LeftParenthesis,  TokenTag::Integer,    TokenTag::LessThan,
        TokenTag::Integer,   TokenTag::RightParenthesis, TokenTag::LeftBrace,  TokenTag::Float,
        TokenTag::Semicolon, TokenTag::RightBrace,       TokenTag::Else,       TokenTag::LeftBrace,
        TokenTag::False,     TokenTag::Semicolon,        TokenTag::RightBrace, TokenTag::Eof};
...
TEST_CASE("test loop", "[WhileLoop]")
{
    ...
    std::vector<TokenTag> expectedTags = {
        TokenTag::LeftBrace,  TokenTag::Var,        TokenTag::Identifier, TokenTag::Assign,
        TokenTag::Integer,    TokenTag::Semicolon,  TokenTag::While,      TokenTag::LeftParenthesis,
        TokenTag::Identifier, TokenTag::LessThan,   TokenTag::Integer,    TokenTag::RightParenthesis,
        TokenTag::LeftBrace,  TokenTag::Identifier, TokenTag::Assign,     TokenTag::Identifier,
        TokenTag::Add,        TokenTag::Integer,    TokenTag::Semicolon,  TokenTag::RightBrace,
...
TEST_CASE("test function declaration", "[Function]")
{
    ...
    Lexer lexer(sourceCodeFile, U"func f(x: Double, y: Double): Double { x + y; }");
